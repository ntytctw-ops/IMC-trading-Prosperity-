...
class Trader:
    ...
    def values_extract(self, order_dict, buy=0): # DONE!!!
        tot_vol = 0 # total volume in one order_depth 
        best_val = -1 # best price in one order_depth 
        mxvol = -1 # 
    ...
    def compute_orders_amethysts(self, product, order_depth, acc_bid, acc_ask): #DONE!!!
        orders: list[Order] = []
    ...
    def compute_orders_regression(self, product, order_depth, acc_bid, acc_ask, LIMIT): # DONE!!!
        orders: list[Order] = []
