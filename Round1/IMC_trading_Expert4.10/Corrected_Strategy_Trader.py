    ...
    def run(self, state: TradingState):
        ...
        for product, order_depth in state.order_depths.items():
            ...
            if product == "STARFRUIT":
                ...
                if short_term_ma > long_term_ma and self.positions[product] < self.position_limit:
                    if is_high_volatility and state.timestamp > 100000:
                        continue
                ...
                elif short_term_ma < long_term_ma and self.positions[product] > -self.position_limit:
                    if is_high_volatility and state.timestamp > 100000:
                        continue
                ...
                if abs(current_mid_price - dynamic_mean) > self.high_volatility_threshold and self.positions[product] < self.position_limit:
